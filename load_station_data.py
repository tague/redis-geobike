...
def load_station_info(r, system_id, station_info_url):
    ...
    with open('./station-data/system-' + str(station_cnt), 'w') as f:
        f.write(json.dumps(info_feed, indent=2, sort_keys=False))
        station_cnt += 1
    ...
    for station in stations:
        ...
        if station['name'].find('Madison') != -1:
            print(station)
...
if __name__ == '__main__':
    ...
    master_feed_list = "https://raw.githubusercontent.com/tague/gbfs/master/systems.csv"
